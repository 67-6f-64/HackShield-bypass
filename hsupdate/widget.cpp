...
namespace gui
{
	...
	{
		this->hwnd = CreateWindowEx(ex_style, class_name.c_str(), widget_name.c_str(), style, rect.get_x(), rect.get_y(), rect.get_width(), rect.get_height(), this->hwnd_parent, reinterpret_cast<HMENU>(menu_handle), this->instance, NULL);
		...
		this->font = CreateFont(13, 0, 0, 0, FW_DONTCARE, 0, 0, 0, ANSI_CHARSET, OUT_DEFAULT_PRECIS,
